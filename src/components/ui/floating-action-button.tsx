...
export default function FloatingActionButton({ className }: FabProps) {
  ...
  return (
    <>
      {/* FAB toggle */}
      <div className={cn('fixed right-5 bottom-5 z-50', className)}>
        <button
          ref={ref}
          type='button'
      ...
      <div
        className={cn(
          'fixed z-50 flex transform-gpu transition-all duration-200 ease-out motion-reduce:transform-none motion-reduce:transition-none',
          open
